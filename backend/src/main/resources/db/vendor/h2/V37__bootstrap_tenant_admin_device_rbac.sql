...
CROSS JOIN (
    VALUES
        ('76300000-0000-0000-0000-000000000021', 'TENANT.DEVICE.READ'),
        ('76300000-0000-0000-0000-000000000022', 'TENANT.DEVICE.CREATE'),
        ('76300000-0000-0000-0000-000000000023', 'TENANT.DEVICE.UPDATE'),
        ('76300000-0000-0000-0000-000000000024', 'TENANT.DEVICE.DELETE')
