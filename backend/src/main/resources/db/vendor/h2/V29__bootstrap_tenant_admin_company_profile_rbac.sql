...
CROSS JOIN (
    VALUES
        ('76300000-0000-0000-0000-000000000017', 'TENANT.COMPANY_PROFILE.READ'),
        ('76300000-0000-0000-0000-000000000018', 'TENANT.COMPANY_PROFILE.CREATE'),
        ('76300000-0000-0000-0000-000000000019', 'TENANT.COMPANY_PROFILE.UPDATE')
