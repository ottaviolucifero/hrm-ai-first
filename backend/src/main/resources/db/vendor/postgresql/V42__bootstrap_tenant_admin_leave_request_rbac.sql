...
CROSS JOIN (
    VALUES
        ('76300000-0000-0000-0000-000000000029', 'TENANT.LEAVE_REQUEST.READ'),
        ('76300000-0000-0000-0000-000000000030', 'TENANT.LEAVE_REQUEST.CREATE'),
        ('76300000-0000-0000-0000-000000000031', 'TENANT.LEAVE_REQUEST.UPDATE'),
        ('76300000-0000-0000-0000-000000000032', 'TENANT.LEAVE_REQUEST.DELETE')
